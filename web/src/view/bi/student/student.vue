...
<template>
  ...
  <el-input v-model="searchInfo.parentName" placeholder="搜索条件" />
</el-form-item>
            
            <el-form-item label="家长手机号" prop="parentPhone">
  <el-input v-model="searchInfo.parentPhone" placeholder="搜索条件" />
</el-form-item>
  ...
  <el-input v-model="searchInfo.remark" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt" width="180">
            ...
            <el-table-column align="left" label="家长姓名" prop="parentName" width="120" />

            <el-table-column align="left" label="家长手机号" prop="parentPhone" width="120" />
    ...
    {{ detailForm.parentName }}
                    ...
                    <el-descriptions-item label="家长手机号">
    {{ detailForm.parentPhone }}
</el-descriptions-item>
